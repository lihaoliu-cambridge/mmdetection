...
def main(stage="train"):
    ...
    out_ann_file = osp.join(output_dir, "annotations", "instances_{}2017.1_2-unlabeled.json".format(stage))
    
    
    ## todo here
    images_txt_path = "/home/ll610/Onepiece/code_cs138/github/TrafficDataset/mmdetection/data/traffic_cambridge/splits/semi-supervised/option3/1_2/train_unlabel.txt"
